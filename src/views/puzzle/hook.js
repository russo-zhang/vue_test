...
export const usePuzzle = () => {
    ...
    */
      ...
      */
        ...
        */
        ...
        moveToInitialPlace() {
            ...
            this.moveTo(puzzle.offsx + (this.pckxmin - 0.5) * puzzle.scalex, puzzle.offsy + (this.pckymin - 0.5) * puzzle.scaley);
        }
    } // class PolyPiece
    ...
    function loadInitialFile() {
        ...
        puzzle.srcImage.src = "https://www.mahjong-jp.com/static/download/wallpaper/2.png";
    }
    //-----------------------------------------------------------------------------
